...
class Visualizer():
    def __init__(self, opt):
        ...
        if self.use_html:
            self.web_dir = os.path.join(opt.train_dir, opt.name, 'web')
            self.img_dir = os.path.join(self.web_dir, 'images')
            print('create web directory %s...' % self.web_dir)
            util.mkdirs([self.web_dir, self.img_dir])
        self.log_name = os.path.join(opt.train_dir, opt.name, 'loss_log.txt')
        self.eval_log_name = os.path.join(opt.train_dir, opt.name, 'eval_log.txt')
